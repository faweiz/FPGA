...
HD_PWD='E:/FPGA/github/FPGA/1_led_sw/1_led_sw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_sw_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_sw_top.tcl
